...
# Test set
adni1 = pd.read_csv('testing_cohorts/adni1_revised.csv')
adni2 = pd.read_csv('testing_cohorts/adni2_revised.csv')
adni3 = pd.read_csv('testing_cohorts/adni3_revised.csv')
adni_go = pd.read_csv('testing_cohorts/adni_go_revised.csv')
adni_df = pd.read_csv('train_vld_test_split_updated/adni_revised_labels.csv')
