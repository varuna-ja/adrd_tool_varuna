...
features = ['RID', 'DIAGNOSIS', 'AGE_MRI', 'SCANDATE.T1', 'LONIUID.T1', 'PTGENDER', 'PTEDUCAT', 'PTTLANG', 'PTETHCAT', 'PTRACCAT', 'AMY_SUVR', 'TRACER.AMY',
            'MTL_SUVR', 'NEO-T_SUVR', 'MMSCORE', 'CDGLOBAL', 'VSBPSYS', 'VSBPDIA',
            'VSPULSE', 'VSRESP']
#%%
