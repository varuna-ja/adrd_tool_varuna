...
bmc = pd.read_csv(f'{basedir}/bmc_revised_stripped_prob_bs128.csv')
...
generate_roc(y_true_, scores_proba_, labels, figname=f'fig4k')
generate_pr(y_true_, scores_proba_, labels, figname=f'fig4l')
